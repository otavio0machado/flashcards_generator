...
import { completeMobileOnboarding, setMobileOnboardingStep } from '@/lib/mobile-onboarding';
...
export default function MobileLoginPage() {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            // Mobile Tauri: open OAuth in system browser, then poll for session
            const { data, error } = await supabase.auth.signInWithOAuth({
                provider: 'google',
                options: {
                    redirectTo: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://flashcardsgenerator.com.br'}/auth/callback`,
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center p-5 bg-[var(--background)] safe-area-inset overflow-auto">
            <div className="w-full max-w-sm">
                ...
                >
                    <div className="mx-auto mb-4 w-14 h-14 bg-brand rounded-xl flex items-center justify-center">
                ...
                <motion.div
                    ...
                    className="bg-[var(--surface,var(--background))] rounded-xl border border-[var(--color-border)] p-5"
                >
                    {/* OAuth Pending State */}
                    {oAuthPending ? (
                        ...
                        <>
                            ...
                            <button
                                ...
                                disabled={loading}
                                type="button"
                                className="w-full flex items-center justify-center gap-2.5 px-4 py-3 bg-[var(--background)] border border-[var(--color-border)] rounded-lg font-medium text-[var(--foreground)] active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-3.5">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-10 pr-4 py-3 bg-[var(--background)] border border-[var(--color-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent text-[var(--foreground)] placeholder:text-[var(--color-text-secondary)] text-sm"
                                                required
                                            />
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            placeholder="••••••••"
                                            className="w-full pl-10 pr-10 py-3 bg-[var(--background)] border border-[var(--color-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent text-[var(--foreground)] placeholder:text-[var(--color-text-secondary)] text-sm"
                                            required
                                            minLength={8}
                                        />
                                        <button
                                            ...
                                            className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--color-text-secondary)] hover:text-[var(--foreground)] p-1"
                                        >
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full flex items-center justify-center gap-2 px-4 py-3.5 bg-brand text-white font-semibold rounded-xl active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {loading ? (
