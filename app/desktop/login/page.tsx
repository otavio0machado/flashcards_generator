                    ...
                    {oAuthPending ? (
                        ...
                        <>
                            ...
                            <button
                                ...
                                disabled={loading}
                                type="button"
                                className="w-full flex items-center justify-center gap-2.5 px-4 py-3 bg-[var(--background)] border border-[var(--color-border)] rounded-lg font-medium text-[var(--foreground)] hover:bg-[var(--surface-muted,var(--surface))] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-brand text-white font-semibold rounded-lg hover:bg-brand/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {loading ? (
