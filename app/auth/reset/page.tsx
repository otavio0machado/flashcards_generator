            ...
            <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
                ...
                >
                    <div className="text-center mb-10">
                        <Link href="/auth/login" className="group inline-flex items-center gap-2 text-sm font-bold text-foreground/40 hover:text-brand mb-8 transition-colors">
                    ...
                    >
                        {success ? (
                            ...
                            >
                                ...
                                <Link
                                    href="/auth/login"
                                    className="group block w-full bg-gray-100 hover:bg-gray-200 text-foreground py-3 rounded-sm font-bold text-sm transition-all mt-6 text-center"
                                >
                                    Voltar para Login
                                </Link>
                            </m.div>
                            ...
                            <form onSubmit={handleReset} className="space-y-4">
                                {error && (
                                    <m.div
                                        initial={{ opacity: 0, y: -10 }}
                                        animate={{ opacity: 1, y: 0 }}
                                        className="p-3 bg-red-50 border border-red-100 rounded-sm text-red-500 text-xs font-bold"
                                    >
                                        {error}
                                    </m.div>
                                )}
