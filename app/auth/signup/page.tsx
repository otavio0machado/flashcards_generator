...
import { ArrowRight, User, Mail, Lock, AlertCircle, Loader2, CheckCircle2, Eye, EyeOff, Zap, Shield, Download } from 'lucide-react';
                ...
                <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
                    ...
                    >
                        <m.div
                            ...
                            className="bg-green-50 w-20 h-20 rounded-full flex items-center justify-center mb-6 mx-auto"
                        >
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="text-[11px] text-foreground/50 font-medium mt-4">
